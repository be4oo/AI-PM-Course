...
- [x] [frontend] [S] TASK-001: Add the new kill-criteria lesson to Module 1 in `src/data/curriculum.js`
      Agent: frontend
      Priority: P0
      Deps: None
...
- [x] [frontend] [S] TASK-002: Add supporting framing in `src/data/lessonEnhancements.js` for the kill-criteria lesson
      Agent: frontend
      Priority: P0
      Deps: TASK-001
...
- [x] [any] [S] TASK-003: Create `docs/templates/kill-criteria-register.md`
      Agent: any
      Priority: P0
      Deps: TASK-001
...
- [x] [any] [S] TASK-004: Update `docs/templates/assessment-rubric-operations.md` and `src/data/capstoneDashboard.js` to require kill-criteria evidence
      Agent: any
      Priority: P0
...
- [x] [frontend] [P] TASK-005: Add the eval-debt lesson to Module 6 in `src/data/curriculum.js`
      Agent: frontend
      Priority: P0
      Deps: TASK-004
...
- [x] [frontend] [P] TASK-006: Extend `src/data/lessonEnhancements.js` with an eval-maintenance tooling lab
      Agent: frontend
      Priority: P0
      Deps: TASK-004
...
- [x] [any] [P] TASK-007: Create `docs/templates/eval-debt-audit.md`
      Agent: any
      Priority: P0
      Deps: TASK-004
...
- [x] [any] [S] TASK-008: Update `docs/templates/assessment-rubric-operations.md` and `src/data/capstoneDashboard.js` to add eval-maintenance evidence
      Agent: any
      Priority: P0
...
- [x] [any] [P] TASK-009: Create `src/data/failureCases.js` with the initial six-case anthology
      Agent: any
      Priority: P0
      Deps: TASK-008
...
- [x] [frontend] [P] TASK-010: Add the failure-anthology lesson to Module 9 in `src/data/curriculum.js`
      Agent: frontend
      Priority: P0
      Deps: TASK-008
...
- [x] [any] [P] TASK-011: Create `docs/templates/failure-debrief-template.md`
      Agent: any
      Priority: P0
      Deps: TASK-008
...
- [x] [frontend] [S] TASK-012: Add `src/components/FailureCaseView.jsx` only if structured rendering is needed
      Agent: frontend
      Priority: P1
...
- [x] [frontend] [S] TASK-013: Seed anthology freshness/changelog integration in `src/data/changelog.js` and related runtime surfaces
      Agent: frontend
      Priority: P1
...
- [x] [infra] [P] TASK-014: Create `docs/ci/weekly-artifact-check.yml`
      Agent: infra
      Priority: P0
...
- [x] [infra] [P] TASK-015: Create `docs/ci/verify-artifacts.js` and `docs/ci/artifact-manifest.example.json`
      Agent: infra
      Priority: P0
      Deps: TASK-004, TASK-008
...
- [x] [any] [P] TASK-016: Create `docs/templates/weekly-artifact-setup-guide.md`
      Agent: any
      Priority: P1
...
- [x] [frontend] [S] TASK-017: Add course references to the CI pack in `src/data/curriculum.js` and/or `src/data/lessonEnhancements.js`
      Agent: frontend
      Priority: P1
...
- [x] [any] [S] TASK-018: Run Wave 2 integration verification across lessons, templates, capstone rubric, and CI pack
      Agent: any
      Priority: P0
