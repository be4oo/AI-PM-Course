...
- [x] **Added gap-matrix entry** in `docs/gap-matrix-2026-04-11.md` ("Unified curriculum doc freshness" row, dated 2026-05-08) tracking the regeneration script and the CI gate as a freshness-control measure.
